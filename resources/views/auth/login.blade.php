...
@endif
<form action="{{route('login')}}" method="post" style="background-image: linear-gradient(#83a4d4,#b6fbff);border:1px solid #ccc" >
  @csrf
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Email"  class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="E-mail" autofocus>
