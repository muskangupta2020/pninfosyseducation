                    ...
                    <ul>
                        ...
                        <li data-index="rs-672" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="upload/slider/slider-image-1.jpg" data-rotate="0" data-saveperformance="off" data-title="unique" data-description="">
                            ...
                            <div class="tp-caption Woo-Rating tp-resizeme" 
                                ...
                                data-splitout="none" 
                                data-responsive_offset="on" 
                                style="z-index: 8; min-width: 370px; max-width: 450px; white-space: normal; text-align:left;"> {{$a->description}}
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="feature-post">
                            ...
                            <div class="feature-content">
                                ...
                                <p>Analyzing negative materials about your brand and addressing them with sentiment analysis
                                    and press.</p>
                            </div>
                        </div>
                    </div>
                ...
                @if ($i == 1)
                    <div class="title-section">
                        ...
                        <div class="right-part">
                            <a class="button-one" href="{{url('front/courses')}}">View All Courses</a>
                        </div>
                    </div>
                    <div class="collection-box">
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                <div class="collection-post">
                                    <div class="inner-collection">
                                        <img src="{{ url('/upload/' . $c->course_image) }}" alt="">
                                        <a href="{{ url('category_course/' . $c->id) }}" class="hover-post">
                                            <span class="title">{{ $c->course_name }}</span>
                            ...
                            @elseif($i==3)
                                <div class="collection-post">
                                    <div class="inner-collection">
                                        <img src="{{ url('/upload/' . $c->course_image) }}"
                                            alt="{{ url('category_course/' . $c->id) }}">
                                        <span class="title">{{ $c->course_name }}</span>
                                        <span class="numb-courses">3 Courses</span>
                                        </a>
                                    </div>
        ...
        <div class="container">
            <div class="countdown-box">
                ...
                <p>We offer professional SEO services that help websites increase their organic search score drastically in
                    order to compete for the highest rankings.</p>
                            ...
                            <div class="course-post">
                                <div class="course-thumbnail-holder">
                                    <a href="{{url('/course_detail/'.$c->id)}}">
                                        <img src="{{ url('/upload/' . $c->course_image) }}" width="100px" height="100px" alt="">
                                    </a>
                                </div>
                                <div class="course-content-holder">
                                    <div class="course-content-main">
                                        ...
                                        <div class="course-rating-teacher">
                                            ...
                                            <a href="#" class="course-loop-teacher"> {{ $c->course_name }}</a>
                                        </div>
                                    </div>
                ...
                <div class="owl-carousel" data-num="1">
                    ...
                    <div class="item">
                        <div class="testimonial-post">
                            <p> “Design-driven, customized and reliable solution for your token development and management
                                system to automate sales processes.”</p>
